...
[Iterator docs](https://doc.rust-lang.org/std/iter/trait.Iterator.html) and almost always find some new useful little helper. The same is even true for containers and even basic types.
