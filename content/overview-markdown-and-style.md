...
<img src="../banner.png" width=45% alt="alt text" style="float: left;" title="Bruce Banner">
<img src="../banner.png" width=45% alt="alt text" style="float: right; "title="Bruce Banner">

# Sample 

{% note(kind="hint", title="Hint") %}
    Here is actual markdown code.
    With some ****random**** **text**.
    Hint some content for various stuff but more
    importantly 
    lot's of text to show. Here is some inline code `somecode`
    but now I follow up with some real code"
{% end %}


{{ code(path='pages/about/playground.rs', extra='hl_lines=10-15') }}


<!--{{ note(kind="question", title="Question I have?", content="-->
    <!--Here is actual markdown code.-->
    <!--With some ****random**** **text**.-->
    <!--Hint some content for various stuff but more-->
    <!--importantly -->
...
<!--{{ note(kind="note", title="Note", content="-->
    <!--Here is actual markdown code.-->
    <!--With some ****random**** **text**.-->
    <!--Hint some content for various stuff but more-->
    <!--importantly -->
    <!--lot's of text to show. Here is some inline code `glClearColor`-->
    <!--but now I follow up with some real code and finally a [link](google.com)"-->
<!--)}}-->

<!--{{ note(kind="warn" title="Warning", content="-->
    <!--Here is actual markdown code.-->
    <!--With some ****random**** **text**.-->
    <!--Hint some content for various stuff but more-->
    <!--importantly -->
...
<!--{{ note(kind="example" title="Example", content="-->
    <!--Here is actual markdown code.-->
    <!--With some ****random**** **text**.-->
    <!--Hint some content for various stuff but more-->
    <!--importantly -->
...
<!--{{ code(path='pages/about/playground.rs', extra="hl_lines=10-150 29") }}-->
